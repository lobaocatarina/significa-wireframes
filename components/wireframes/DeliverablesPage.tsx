...
export function DeliverablesPage() {
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* Categories */}
      <div className="border-b border-[#e0e0e0] py-16">
          ...
          <div className="grid grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col gap-6">
                ...
                <div>
                  <h3 className="text-[18px] font-medium text-black leading-[24px] mb-4 text-center">{category.title}</h3>
          ...
          <div className="grid grid-cols-2 gap-16 items-center mb-16">
            <div>
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-[18px] font-medium text-black leading-[24px] mb-2 text-center">1. Discovery & Research</h3>
                ...
                <div>
                  <h3 className="text-[18px] font-medium text-black leading-[24px] mb-2 text-center">2. Strategy & Planning</h3>
                  <p className="text-[16px] text-black opacity-80 leading-[24px]">
                    Based on insights, we develop a strategic plan and roadmap for your project.
                  </p>
                </div>
                <div>
                  <h3 className="text-[18px] font-medium text-black leading-[24px] mb-2 text-center">3. Design & Development</h3>
                  <p className="text-[16px] text-black opacity-80 leading-[24px]">
                    Our team creates and builds solutions that are both beautiful and functional.
                  </p>
                </div>
                <div>
                  <h3 className="text-[18px] font-medium text-black leading-[24px] mb-2 text-center">4. Testing & Optimization</h3>
                  <p className="text-[16px] text-black opacity-80 leading-[24px]">
