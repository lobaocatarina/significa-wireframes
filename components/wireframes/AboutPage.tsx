    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-[1400px] mx-auto px-5 py-16">
        ...
        <div className="text-center mb-12">
          <h2 className="text-[32px] font-medium text-black leading-[36px] mb-4">Our team</h2>
        ...
        <div className="grid grid-cols-4 gap-8 mb-16">
          {[...Array(8)].map((_, i) => (
            <div key={i} className="text-center">
              ...
              <h3 className="text-[18px] font-medium text-black leading-[24px] mb-1">Team Member Name</h3>
        ...
        <div className="text-center">
          <WireframeButton variant="secondary">View Full Team</WireframeButton>
        </div>
      </div>
      ...
      <div className="bg-[#f8f9fa] py-16">
        <div className="max-w-[1400px] mx-auto px-5">
          ...
          <div className="text-center mb-12">
            <h2 className="text-[32px] font-medium text-black leading-[36px] mb-4">Where we work</h2>
          ...
          <div className="grid grid-cols-3 gap-12 mb-12">
            {[
              ...
              <div key={i} className="text-center">
                ...
                <h3 className="text-[24px] font-medium text-black leading-[32px] mb-2">{location.city}</h3>
                <p className="text-[18px] text-black opacity-50 leading-[24px] mb-3">{location.country}</p>
                <p className="text-[16px] text-black opacity-80 leading-[24px]">{location.description}</p>
              </div>
            ))}
          </div>
      ...
      <div className="max-w-[1400px] mx-auto px-5 py-16">
        ...
        <div className="grid grid-cols-2 gap-16 items-center mb-16">
          <div>
            <h2 className="text-[32px] font-medium text-black leading-[36px] mb-6">Our mission</h2>
        ...
        <div className="grid grid-cols-3 gap-12">
          {[
            ...
            <div key={i}>
              ...
              <h3 className="text-[18px] font-medium text-black leading-[24px] mb-3">{value.title}</h3>
      ...
      <div className="bg-[#f8f9fa] py-16">
        <div className="max-w-[1400px] mx-auto px-5">
          ...
          <div className="grid grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-[32px] font-medium text-black leading-[36px] mb-6">Certified B Corp</h2>
              <p className="text-[18px] text-[rgba(0,0,0,0.8)] leading-[24px] mb-8">
